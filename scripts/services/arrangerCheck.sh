#!/bin/sh
        ...
        until curl -s -o /dev/null -w "%{http_code}" "http://arranger-growth:5051/graphql" | tr -d '/' | grep -q "200"; do
          echo -e "\033[1;36mGrowth Data Arranger:\033[0m Not yet reachable, checking again in 20 seconds"
          sleep 20
        done
        echo -e "\033[1;32mSuccess:\033[0m Arranger Growth is now reachable"
