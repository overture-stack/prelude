...
echo -e "\033[1;35m[3/10]\033[0m Waiting for Elasticsearch (this may take a few minutes)"
sleep 20
...
echo -e "\033[1;35m[4/10]\033[0m Setting up Elasticsearch index template"
...
echo -e "\033[1;35m[5/10]\033[0m Setting up Elasticsearch index and alias"
...
echo -e "\033[1;35m[6/10]\033[0m Importing Elasticsearch Documents"
