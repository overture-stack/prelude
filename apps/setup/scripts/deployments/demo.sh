...
# Welcome
echo -e "\n\033[1;36m╔═════════════════════════════════╗\033[0m"
echo -e "\033[1;36m║   Spinning up the Demo Portal   ║\033[0m"
...
# Check Arranger
echo -e "\n\033[1;35m[4/5]\033[0m Checking Arranger Instances"
rs "$SCRIPT_DIR/arranger/arranger_check.sh"

# Check Custom UI
echo -e "\n\033[1;35m[5/5]\033[0m Checking Custom UI"
rs "$SCRIPT_DIR/custom-ui/custom_ui_check.sh"
