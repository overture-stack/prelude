...
const SubmitData = (): ReactElement => {
	...
	const statusColor: Record<Status, string> = {
		...
		partial: theme.colors.warning_dark,
	...
	return (
		<PageLayout subtitle="Data Submitter">
			<main
				css={css`
			...
			>
				<HeroBanner
					...
					description="Upload a CSV file to ingest data into PostgreSQL and Elasticsearch."
				...
				>
					...
					<section css={sectionStyle}>
						...
						>
							...
							<div>
								...
								{indexBase.trim() ? (
									<p css={helpTextStyle}>
										Targets: <strong>{indexName}</strong>
									</p>
								) : (
					...
					{result && status && (
						...
						>
							...
							>
								{[
									{ label: 'Total rows', value: result.total, color: theme.colors.primary },
									...
									{ label: 'Skipped (duplicates)', value: result.skipped, color: theme.colors.grey_5 },
									{
										...
										color: result.indexed > 0 ? theme.colors.secondary : theme.colors.grey_5,
									},
