...
module.exports = withPlugins([withTranspileModules], {
	...
	publicRuntimeConfig: {
		...
		NEXT_PUBLIC_ARRANGER_TABULAR_MANIFEST_COLUMNS:
			process.env.NEXT_PUBLIC_ARRANGER_TABULAR_MANIFEST_COLUMNS || '',
		NEXT_PUBLIC_ARRANGER_TABULAR_MAX_BUCKET_COUNTS:
			process.env.NEXT_PUBLIC_ARRANGER_TABULAR_MAX_BUCKET_COUNTS || 1000,
