...
module.exports = withPlugins([withTranspileModules], {
	...
	publicRuntimeConfig: {
		...
		// CLINICAL
		NEXT_PUBLIC_ARRANGER_CLINICAL_DATA_API: process.env.NEXT_PUBLIC_ARRANGER_CLINICAL_DATA_API,
		NEXT_PUBLIC_ARRANGER_CLINICAL_DATA_DOCUMENT_TYPE: process.env.NEXT_PUBLIC_ARRANGER_CLINICAL_DATA_DOCUMENT_TYPE,
		NEXT_PUBLIC_ARRANGER_CLINICAL_DATA_INDEX: process.env.NEXT_PUBLIC_ARRANGER_CLINICAL_DATA_INDEX,
		NEXT_PUBLIC_ARRANGER_CLINICAL_DATA_CARDINALITY_PRECISION_THRESHOLD:
			process.env.NEXT_PUBLIC_ARRANGER_CLINICAL_DATA_CARDINALITY_PRECISION_THRESHOLD || 3000,
		NEXT_PUBLIC_ARRANGER_CLINICAL_DATA_MANIFEST_COLUMNS:
			process.env.NEXT_PUBLIC_ARRANGER_CLINICAL_DATA_MANIFEST_COLUMNS || '',
		NEXT_PUBLIC_ARRANGER_CLINICAL_DATA_MAX_BUCKET_COUNTS:
			process.env.NEXT_PUBLIC_ARRANGER_CLINICAL_DATA_MAX_BUCKET_COUNTS || 1000,
