...
module.exports = withPlugins([withTranspileModules], {
	...
	publicRuntimeConfig: {
		...
		// File
		NEXT_PUBLIC_ARRANGER_FILE_API: process.env.NEXT_PUBLIC_ARRANGER_FILE_API,
		NEXT_PUBLIC_ARRANGER_FILE_DOCUMENT_TYPE: process.env.NEXT_PUBLIC_ARRANGER_FILE_DOCUMENT_TYPE,
		NEXT_PUBLIC_ARRANGER_FILE_INDEX: process.env.NEXT_PUBLIC_ARRANGER_FILE_INDEX,
		NEXT_PUBLIC_ARRANGER_FILE_CARDINALITY_PRECISION_THRESHOLD:
			process.env.NEXT_PUBLIC_ARRANGER_FILE_CARDINALITY_PRECISION_THRESHOLD || 3000,
		NEXT_PUBLIC_ARRANGER_MANIFEST_COLUMNS: process.env.NEXT_PUBLIC_ARRANGER_MANIFEST_COLUMNS || '',
		NEXT_PUBLIC_ARRANGER_FILE_MAX_BUCKET_COUNTS: process.env.NEXT_PUBLIC_ARRANGER_FILE_MAX_BUCKET_COUNTS || 1000,
		NEXT_PUBLIC_ENABLE_FILE_QUICKSEARCH: process.env.NEXT_PUBLIC_ENABLE_FILE_QUICKSEARCH,

		// Tabular
		NEXT_PUBLIC_ARRANGER_TABULAR_API: process.env.NEXT_PUBLIC_ARRANGER_TABULAR_API,
		NEXT_PUBLIC_ARRANGER_TABULAR_DOCUMENT_TYPE: process.env.NEXT_PUBLIC_ARRANGER_TABULAR_DOCUMENT_TYPE,
		NEXT_PUBLIC_ARRANGER_TABULAR_INDEX: process.env.NEXT_PUBLIC_ARRANGER_TABULAR_INDEX,
		NEXT_PUBLIC_ARRANGER_TABULAR_CARDINALITY_PRECISION_THRESHOLD:
			process.env.NEXT_PUBLIC_ARRANGER_TABULAR_CARDINALITY_PRECISION_THRESHOLD || 3000,
		NEXT_PUBLIC_ARRANGER_TABULAR_MANIFEST_COLUMNS: process.env.NEXT_PUBLIC_ARRANGER_TABULAR_MANIFEST_COLUMNS || '',
		NEXT_PUBLIC_ARRANGER_TABULAR_MAX_BUCKET_COUNTS: process.env.NEXT_PUBLIC_ARRANGER_TABULAR_MAX_BUCKET_COUNTS || 1000,
