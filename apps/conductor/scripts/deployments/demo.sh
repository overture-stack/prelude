...
# Welcome
echo -e "\n\033[1;36mSpinning up the JBrowse Demo Portal\033[0m"
echo -e "\033[1;36m════════════════════════════════════\033[0m"

# Minio Check
echo -e "\n\033[1;35m[1/9]\033[0m Checking Minio Object Storage"
rs "${SCRIPT_DIR}/score/object_storage_check.sh"

# Score Setup
echo -e "\n\033[1;35m[2/9]\033[0m Checking on Score (this may take a few minutes)"
rs "${SCRIPT_DIR}/score/score_check.sh"

# Song Setup
echo -e "\n\033[1;35m[3/9]\033[0m Checkng on Song"
...
echo -e "\n\033[1;35m[6/9]\033[0m Updating Conductor health status"
...
# Check Arranger
echo -e "\n\033[1;35m[8/9]\033[0m Checking Arranger"
...
echo -e "\n\033[1;36mJBrowse Demo Portal Running\033[0m"
echo -e "\033[1;36m═══════════════════════════\033[0m\n"
echo -e "\033[1m🌐 The demo portal should now be available at:\033[0m"
