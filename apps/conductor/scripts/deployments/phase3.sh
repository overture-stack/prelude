...
echo -e "\033[1;35m[1/13]\033[0m Cleaning up existing health check files"
rs "${P1_SCRIPT_DIR}/healthcheckCleanup.sh"

# Lectern Setup
echo -e "\033[1;35m[2/13]\033[0m Checking on Lectern"
rs "${P2_SCRIPT_DIR}/lecternCheck.sh"

# Lyric Setup
echo -e "\033[1;35m[3/13]\033[0m Checking on Lyric"
rs "${P2_SCRIPT_DIR}/lyricCheck.sh"

# Minio Check
echo -e "\033[1;35m[4/13]\033[0m Checking Minio Object Storage"
rs "${P3_SCRIPT_DIR}/objectStorageCheck.sh"

# Score Setup
echo -e "\033[1;35m[5/13]\033[0m Checking on Score (this may take a few minutes)"
rs "${P3_SCRIPT_DIR}/scoreCheck.sh"

# Song Setup
echo -e "\033[1;35m[6/13]\033[0m Checking on Song"
rs "${P3_SCRIPT_DIR}/songCheck.sh"

# Elasticsearch Check
echo -e "\033[1;35m[7/13]\033[0m Checking Elasticsearch (this may take a few minutes)"
rs "${P1_SCRIPT_DIR}/elasticsearchCheck.sh"

# Elasticsearch (File) Setup
echo -e "\033[1;35m[8/13]\033[0m Setting up File Data in Elasticsearch"
rs "${P1_SCRIPT_DIR}/elasticsearchSetupFileData.sh"

# Elasticsearch (Tabular) Setup
echo -e "\033[1;35m[9/13]\033[0m Setting Tabular Data in Elasticsearch"
rs "${P1_SCRIPT_DIR}/elasticsearchSetupTabularData.sh"

# Update Conductor to Healthy Status
echo -e "\033[1;35m[10/13]\033[0m Updating Conductor health status"
echo "healthy" > /health/conductor_health
echo -e "\033[1;36mConductor:\033[0m Updating Container Status. Health check file created"

# Check Stage
echo -e "\033[1;35m[11/13]\033[0m Checking Stage"
